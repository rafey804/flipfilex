...
export default function HomePage() {
  ...
  const allTools = [
    ...
    { name: 'MP4 to GIF', href: '/mp4-to-gif', description: 'Convert MP4 video to GIF animation', category: 'Video' },
    { name: 'MOV to GIF', href: '/mov-to-gif', description: 'Convert MOV video to GIF animation', category: 'Video' },
    { name: 'AVI to GIF', href: '/avi-to-gif', description: 'Convert AVI video to GIF animation', category: 'Video' },
    { name: 'GIF to MP4', href: '/gif-to-mp4', description: 'Convert GIF animation to MP4 video', category: 'Video' },
    ...
    { name: 'AI Voice Dubbing', href: '/ai-voice-dubbing', description: 'Generate natural voices and clone voices with AI in multiple languages', category: 'AI Tools' }
  ];
