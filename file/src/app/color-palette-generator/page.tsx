...
export default function ColorPaletteGenerator() {
  ...
  return (
    <>
      <Head>
        <title>Free Color Palette Generator Online - Professional Color Schemes | FlipFileX</title>
        <meta name="description" content="Generate beautiful color palettes with professional harmony rules online for free. Support for multiple formats, accessibility checking, and real-time preview for designers." />
        <meta name="keywords" content="color palette generator, color scheme, harmony, complementary, triadic, analogous, hex, rgb, hsl, cmyk, design tools, color theory, web design" />
        <meta name="author" content="FlipFileX" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="theme-color" content="#3b82f6" />
        <meta name="application-name" content="FlipFileX Color Palette Generator" />

        {/* Open Graph tags */}
        <meta property="og:title" content="Free Color Palette Generator Online - Professional Color Schemes | FlipFileX" />
        <meta property="og:description" content="Generate beautiful color palettes with professional harmony rules online for free. Perfect for designers and developers." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://flipfilex.com/color-palette-generator" />
        ...
        <meta name="twitter:title" content="Free Color Palette Generator Online - Professional Color Schemes | FlipFileX" />
        <meta name="twitter:description" content="Generate beautiful color palettes with professional harmony rules online for free. Perfect for designers and developers." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Generate beautiful color palettes with professional harmony rules online for free",
