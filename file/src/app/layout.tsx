...
export const metadata: Metadata = {
  ...
  keywords: [
    'online file converter', 'free file converter', 'PDF converter', 'image converter',
    'video converter', 'audio converter', 'FlipFileX', 'file conversion tools',
    'PDF tools', 'AI tools', 'online tools'
  ],
