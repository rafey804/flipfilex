...
export default function ToolsPage() {
 ...
 const audioConverters = [
  ...
  const utilityTools = [
    ...
    { path: '/ai-background-remover', fromName: 'Image', toName: 'No Background', description: 'Remove image backgrounds automatically with AI - 100% free', icon: '🖼️', gradient: 'from-cyan-600 to-blue-600' },
