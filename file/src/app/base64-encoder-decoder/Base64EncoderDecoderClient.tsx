                            ...
                            <div className="flex justify-center mb-8">
                                <div className="bg-gray-100 rounded-2xl p-2 flex">
                                    <button
                                        ...
                                        className={`px-8 py-3 rounded-xl font-semibold transition-all duration-300 ${activeMode === 'encode'
                                    ...
                                    <button
                                        ...
                                        className={`px-8 py-3 rounded-xl font-semibold transition-all duration-300 ${activeMode === 'decode'
                                    ...
                                    <div className="flex justify-center mb-4">
                                        <div className="bg-gray-100 rounded-xl p-1 flex">
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${inputType === 'text'
                                            ...
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${inputType === 'file'
                                                        ? 'bg-white text-cyan-600 shadow-sm'
                                                        : 'text-gray-600 hover:text-gray-800'
                                                    }`}
                                            >
                                    ...
                                    {results.map((result, index) => (
                                        <div key={result.id} className="bg-cyan-50/50 rounded-2xl p-6 border border-cyan-200/30">
                                            <div className="flex items-center justify-between mb-3">
                                                <div className="flex items-center space-x-3">
                                                    <span className={`px-3 py-1 text-white text-sm font-bold rounded-full ${result.operation === 'encode' ? 'bg-cyan-500' : 'bg-teal-500'
                                                        }`}>
