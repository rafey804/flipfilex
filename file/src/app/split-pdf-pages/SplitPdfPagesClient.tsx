...
export default function SplitPdfPagesClient() {
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid md:grid-cols-3 gap-4">
                                            <label className={`cursor-pointer p-4 rounded-xl border-2 transition-all ${splitMode === 'all' ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200 bg-white'
                                                }`}>
                                                <input
                                                    type="radio"
                                                    name="splitMode"
                                            ...
                                            <label className={`cursor-pointer p-4 rounded-xl border-2 transition-all ${splitMode === 'odd' ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200 bg-white'
                                                }`}>
                                                <input
                                                    type="radio"
                                                    name="splitMode"
                                            ...
                                            <label className={`cursor-pointer p-4 rounded-xl border-2 transition-all ${splitMode === 'even' ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200 bg-white'
                                                }`}>
                                                <input
                                                    type="radio"
                                                    name="splitMode"
                                    ...
                                    {/* Custom Range Option */}
                                    <div>
                                        <label className={`cursor-pointer p-4 rounded-xl border-2 transition-all ${splitMode === 'custom' ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200 bg-white'
                                            }`}>
                                            <input
                                                type="radio"
                                                name="splitMode"
