...
export default function StlToObjPage() {
  ...
  return (
    <>
      <head>
        <title>Free STL to OBJ Converter Online - 3D Model Format Converter | FlipFileX</title>
        <meta name="description" content="Convert STL files to OBJ format online for free. Perfect for 3D printing, modeling, and cross-platform 3D file compatibility." />
        <meta name="keywords" content="STL to OBJ, 3D converter, 3D model converter, STL converter, OBJ converter, 3D printing" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://flipfilex.com/stl-to-obj" />
      </head>
