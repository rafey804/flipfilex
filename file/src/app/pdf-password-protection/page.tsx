...
export default function PDFPasswordProtectionPage() {
  ...
  return (
    <>
      <Head>
        <title>Free PDF Password Protection | FlipFileX</title>
        <meta name="description" content="Add password protection to PDF files for free. Secure your documents with 256-bit AES encryption, prevent unauthorized access, copying, and editing." />
        <meta name="keywords" content="PDF password protection, secure PDF, encrypt PDF, PDF security, password protect PDF, PDF encryption, secure documents, protect PDF files, PDF privacy, confidential PDFs" />
        <meta name="author" content="FlipFileX" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />

        {/* Open Graph Meta Tags */}
        <meta property="og:title" content="Free PDF Password Protection | FlipFileX" />
        <meta property="og:description" content="Add password protection to PDF files for free. Secure your documents with 256-bit AES encryption and prevent unauthorized access." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://flipfilex.com/pdf-password-protection" />
        <meta property="og:image" content="https://flipfilex.com/images/pdf-password-protection-og.jpg" />
        <meta property="og:site_name" content="FlipFileX" />
        <meta property="og:locale" content="en_US" />

        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Free PDF Password Protection | FlipFileX" />
        <meta name="twitter:description" content="Add password protection to PDF files for free. Secure your documents with 256-bit AES encryption." />
        <meta name="twitter:image" content="https://flipfilex.com/images/pdf-password-protection-twitter.jpg" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Add password protection to PDF files for free with 256-bit AES encryption",
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <label className={`cursor-pointer p-4 rounded-xl border-2 transition-all ${
                          encryptionLevel === 'standard' ? 'border-red-500 bg-red-50' : 'border-gray-200 bg-white'
                        }`}>
                          <input
                            type="radio"
                            name="encryption"
                        ...
                        <label className={`cursor-pointer p-4 rounded-xl border-2 transition-all ${
                          encryptionLevel === 'high' ? 'border-red-500 bg-red-50' : 'border-gray-200 bg-white'
                        }`}>
                          <input
                            type="radio"
                            name="encryption"
