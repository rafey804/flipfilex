...
export default function URLShortenerPage() {
  ...
  return (
    <>
      <Head>
        <title>Free URL Shortener Online - Create Short Links & Custom URLs | Link Shortener</title>
        <meta name="description" content="Shorten long URLs instantly with our free URL shortener. Create custom short links, track clicks, manage links. Fast, reliable & easy to use link shortener tool." />
        <meta name="keywords" content="url shortener, link shortener, short url, shorten link, custom url, tiny url, short link generator, url shortener free, link management, click tracking" />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://flipfilex.com/url-shortener" />
        <meta property="og:title" content="Free URL Shortener - Create Short Links & Custom URLs" />
        <meta property="og:description" content="Shorten URLs instantly. Create custom short links with click tracking. Free, fast & reliable URL shortener." />
        <meta property="og:image" content="https://flipfilex.com/og-url-shortener.png" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Free URL Shortener | Create Short Links" />
        <meta name="twitter:description" content="Shorten URLs instantly with custom aliases and click tracking." />
        <meta name="twitter:image" content="https://flipfilex.com/og-url-shortener.png" />
